# Superintendent Development Guidelines
...
Superintendent stores state in Linear:
- **Labels on tickets**: `readiness:XX`, `sup:working`, `sup:eval:timestamp`
- **State project**: "Superintendent State" contains daemon status, agent sessions, and error reports
...
Errors are automatically reported to Linear as issues in the "Superintendent State" project. Check there for runtime errors.
