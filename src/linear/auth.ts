...
// Scopes needed for Superintendent
...
export class LinearAuth {
  ...
  async getAccessToken(): Promise<string> {
    ...
    throw new Error(
      'No valid Linear OAuth token. Run `npm run auth` to authorize Superintendent with Linear.'
    );
  }
    ...
    return new Promise((resolve, reject) => {
      const server = http.createServer((req, res) => {
        ...
        res.end(`
          <!DOCTYPE html>
          <html>
            <head><title>Superintendent Authorization</title></head>
