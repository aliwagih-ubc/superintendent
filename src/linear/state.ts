 ...
 *    - Uses a "Superintendent State" project in Linear
...
const STATE_PROJECT_NAME = 'Superintendent State';
  ...
  async initialize(): Promise<void> {
    ...
    if (existingProject) {
      ...
      const result = await client.createProject({
        ...
        description: 'Internal state tracking for Superintendent. Do not modify manually.',
      });
