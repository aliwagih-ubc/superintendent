 ...
 * - Mention-driven: Users trigger actions via @superintendent mentions
...
export class QueueScheduler {
  ...
  // Track tickets we're waiting for responses on
   ...
   * Users must @superintendent in Linear comments to trigger actions.
   */
  start(): void {
    if (this.running) {
